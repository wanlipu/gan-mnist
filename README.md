...
This is part of Udacity Deep Learning Program, and this repository is meant to document my progress towards Generative Adversarial Network (GAN) study.

In this notebook, I learnt how to build a generative adversarial network (GAN) trained on the MNIST dataset.
